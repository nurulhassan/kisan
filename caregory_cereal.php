...
$con=mysqli_connect("localhost","root","","kisanmart") or die(mysqli_error($con));
 ...
 $query = "select * from products where category='cereal'";
...
<div class="container">
    ...
    <div class="search_padding">
     ...
     <h3><b><u>Featured Ads:</u><i>Category(Cereal)</i></b></h3><br/> 
  ...
  <div class="row" style="margin-top: 20px; border-style:inset;">
    <div class="col-sm-3 col-sm-5">
      ...
      <img class="panel1" src=" view1.php ?id=1 " style="width:220px;height:180px;border-radius: 20px;" alt="responsive">
    </div>
